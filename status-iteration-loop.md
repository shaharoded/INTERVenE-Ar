...
## Appendix — P6 iteration-loop architecture sweep results

These entries originated in status.md during the iteration loop's P6 phase
(full-data architecture scale-up on the 11-outcome iteration-loop dataset).
Moved here when the benchmarking phase began.

### P6 / M-128 @ FULL DATAed)
